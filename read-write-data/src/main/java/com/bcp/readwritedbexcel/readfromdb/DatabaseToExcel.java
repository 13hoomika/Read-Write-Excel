...
public class DatabaseToExcel {
    public static void main(String[] args) throws SQLException, IOException {
        ...
        ResultSet rs = stmt.executeQuery("SELECT * FROM restro_table");
       ...
       int r = 1;
       while (rs.next()){
           int restoId = rs.getInt("id");
           boolean isRestroOpem = rs.getBoolean("isOpen");
           String restroLocation = rs.getString("location");
           double restroRating = rs.getDouble("rating");
           String nameOfRestro = rs.getString("restroName");
       ...
       FileOutputStream fos = new FileOutputStream(".\\datafiles\\restro.xlsx");
       workbook.write(fos);
       workbook.close();
       fos.close();
       conn.close();
